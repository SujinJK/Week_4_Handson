...
Three real bugs showed up the first few times the loop ran against live questions, not in theory — worth recording honestly rather than pretending the first version worked:
