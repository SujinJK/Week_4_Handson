...
Two real bugs showed up the first time the loop ran against a live question, not in theory — worth recording honestly rather than pretending the first version worked:
